import { StatusBtnPipe } from './status-btn.pipe';
  ...
  },
  {
      ...
      "products": [
          ...
          },
          {
              ...
              "_id": "623363315f4f1173a3bc9257"
          },
          {
              "qty": 1,
              "product": {
                  "_id": "622f7724fdae5851e3ff9bc7",
                  "name": "French fries",
                  "price": 5,
                  "image": "https://firebasestorage.googleapis.com/v0/b/burgerland-63cee.appspot.com/o/french.png?alt=media&token=d2406317-fcae-4dd1-8ee8-edcd2200de85",
                  "type": "lunch",
                  "dateEntry": "2022-03-14T17:11:00.057Z",
                  "createdAt": "2022-03-14T17:11:00.058Z",
                  "updatedAt": "2022-03-14T17:11:00.058Z"
              },
              "_id": "623363315f4f1173a3bc9258"
          },
          {
              "qty": 1,
              "product": {
                  "_id": "622f76f6fdae5851e3ff9bc4",
                  "name": "Simple burger",
                  "price": 10,
                  "image": "https://firebasestorage.googleapis.com/v0/b/burgerland-63cee.appspot.com/o/simple%20bur.png?alt=media&token=4e8690fe-642c-4e24-ba6e-b4df2c6e212a",
                  "type": "lunch",
                  "dateEntry": "2022-03-14T17:10:14.963Z",
                  "createdAt": "2022-03-14T17:10:14.964Z",
                  "updatedAt": "2022-03-14T17:10:14.964Z"
              },
      ...
      "updatedAt": "2022-03-25T00:09:31.007Z"
  }
];

const ordersDataStatusDelivering = [
    {
        "_id": "623362745f4f1173a3bc9248",
        "userId": "622aac2dd1a4b35c1621500e",
        "client": "Harry",
  ...
  const ordersDataStatusReadyToServe = [
    {
        "_id": "623362745f4f1173a3bc9248",
        "userId": "622aac2dd1a4b35c1621500e",
        "client": "Harry",
...
describe('StatusBtnPipe', () => {

  it('create an instance', () => {
    const pipe = new StatusBtnPipe();
    expect(pipe).toBeTruthy();
  });

  it('It must return all orders without modifying the status property if it is different from "delivering"', () => {
    const pipe = new StatusBtnPipe();
    const result = pipe.transform(ordersData);
    expect(result.length).toBe(5)
  })

  it('You must return the modified orders in the status property to "ready to serve" if it is equal to "delivering"', () => {
    const pipe = new StatusBtnPipe();
    const result = pipe.transform(ordersDataStatusDelivering);
    expect(result).toEqual(ordersDataStatusReadyToServe);
  })
